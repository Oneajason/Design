...
<head>
    ...
    <title>UI Portfolio - Personal Category Bootstrap Responsive Website Template - About</title>
        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="content-info-in row">
                ...
                <div class="content-gd col-lg-7 mt-lg-0 mt-5 align-self ps-lg-5">
                    ...
                    <h5 class="w3l-subtitle mb-md-5 mb-4">Having O6 Years of Experience. I Would Love to make your Ideas real. I Can give your business a new Creative start right away!</h5>
        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="middle-section text-center">
                <div class="section-width">
                    <h3 class="w3l-title-main"> Take a tour of my office. A Video presentation of my beautiful & awesome story.</h3>
                ...
                <div class="history-info mt-5">
                    <div class="position-relative">
                        <img src="assets/images/blog9.jpg" class="img-fluid radius-image video-popup-image"
                            alt="video-popup">
                        ...
                        <div id="small-dialog" class="zoom-anim-dialog mfp-hide">
                            <iframe src="#" sandbox=""" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-7 video-info pe-lg-5">
                <div class="title-content">
                    ...
                    <p class="pe-lg-5">Lorem ipsum viverra feugiat. Pellen tesque libero ut justo. Semper at tempufddfel. Lorem ipsum dolor sit, amet consectetur elit.</p>
...
<div class="container py-4">
    <div class="row footer-grids">
        <div class="col-lg-6 copyright text-lg-start text-center align-center">
            <p>© 2022 UI Portfolio. All Rights Reserved | <a target="_blank" href="http://www.mobanwang.com/" title="网页模板">网页模板</a> </p>
        </div>
